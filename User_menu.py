...
class User:
    ...
    def user_mainmenu(self,a,b):
        self.mainw.iconbitmap(r'C:\Caixa - Karis Korban\icons\icon.ico')
    ...
    def user_input(self):
        ...
        Button(self.entryframe, text="Efetuar", bd=1, width=8, height=7,
            bg="#9ACD32", font="roboto 10").place(x=0, y=30)
        Button(self.entryframe, text="Add Carrinho", bd=1, width=10,
            height=3, bg="#9ACD32", font="roboto 10").place(x=100, y=80)
        Button(self.entryframe, text="Remover", bd=1, width=10,
            height=3, bg="#9ACD32", font="roboto 10").place(x=210, y=80)
        ...
        Label(self.entryframe, text="Quantidade",
            font="roboto 12 bold", bg="#9ACD32").place(x=318, y=0)
        Label(self.entryframe, text="Pesquisar",
            font="roboto 12 bold", bg="#9ACD32").place(x=100, y=0)
        Label(self.entryframe, text="Valor Pagar",
            font="roboto 14 bold", bg="#9ACD32").place(x=0, y=205)
        self.cur.execute("")

        Label(self.tableframe1, text="N_Cupon. ",
            font="roboto 14 bold", bg="#9ACD32").grid(row=0, column=0)

        va = 0 + 65

        Entry(self.entryframe1,  font="roboto 14", bg="#FFFFFF",
            width=25, state='readonly').place(x=162, y=0, height=40)
        Entry(self.entryframe1, font="roboto 14", bg="#FFFFFF",
            width=25, state='readonly').place(x=162, y=65, height=40)
        Entry(self.entryframe1, font="roboto 14", bg="#FFFFFF",
            width=25, state='readonly').place(x=162, y=65*2, height=40)
        Entry(self.entryframe1, font="roboto 14", bg="#FFFFFF",
            width=25, state='readonly').place(x=162, y=65*3, height=40)
        self.id_qty = {}
        self.cur.execute("")
